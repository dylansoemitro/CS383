...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #print(self._lda._doc_topic_counts)
        # print(self._lda._doc_counts)
        # print(self._lda._doc_assign)
        doc_len = {0:4, 1:3, 2:4}
        for dd in doc_len:
        ...
        # print(self._lda._doc_counts)
        # print(self._lda._doc_assign)
        # print(self._lda.get_doc(0))
        # print(self._lda.get_doc(1))

        # print(self._lda.get_doc(2))
        ...
        # print(self._lda._topics._topic_term)
